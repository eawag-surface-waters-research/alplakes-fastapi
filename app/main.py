...
@app.get("/simulations/profile/{model}/{lake}/{parameter}/{datetime}/{latitude}/{longitude}", tags=["Simulations"])
async def simulations_profile(model: simulations.Models, lake: simulations.Lakes, parameter: simulations.Parameters,
                              datetime: str, latitude: float, longitude: float):
    """
    ...
    """
    simulations.verify_simulations_profile(model, lake, parameter, datetime, latitude, longitude)
    return simulations.get_simulations_profile(filesystem, model, lake, parameter, datetime, latitude, longitude)


@app.get("/simulations/transect/{model}/{lake}/{parameter}/{datetime}/{latitude_list}/{longitude_list}", tags=["Simulations"])
async def simulations_transect(model: simulations.Models, lake: simulations.Lakes, parameter: simulations.Parameters,
                               datetime: str, latitude_list: str, longitude_list: str):
    """
    ...
    """
    simulations.verify_simulations_transect(model, lake, parameter, datetime, latitude_list, longitude_list)
    return simulations.get_simulations_transect(filesystem, model, lake, parameter, datetime, latitude_list,
                                                longitude_list)


@app.get("/simulations/depthtime/{model}/{lake}/{parameter}/{start}/{end}/{latitude}/{longitude}", tags=["Simulations"])
async def simulations_depth_time(model: simulations.Models, lake: simulations.Lakes, parameter: simulations.Parameters,
                                 start: str, end: str, latitude: float, longitude: float):
    """
    ...
    - **longitude**: Longitude (WGS84)
    """
    simulations.verify_simulations_depthtime(model, lake, parameter, start, end, latitude, longitude)
    return simulations.get_simulations_depthtime(filesystem, model, lake, parameter, start, end, latitude, longitude)
